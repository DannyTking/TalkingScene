...
CREATE TABLE "SceneTable" ("SceneID" INTEGER PRIMARY KEY  NOT NULL ,"SceneName" TEXT NOT NULL ,"SceneIcon" TEXT NOT NULL ,"SceneBrief" TEXT NOT NULL,"SceneBrief" INTEGER NOT NULL  DEFAULT (0));
...
CREATE TABLE StoryTable ("StoryID" INTEGER PRIMARY KEY NOT NULL UNIQUE, "StoryName" TEXT NOT NULL DEFAULT 'ST_', "StroyIcon" TEXT NOT NULL,  "StoryBrief" TEXT NOT NULL DEFAULT '_BRF', "StoryAuthor" TEXT DEFAULT '_ATH', StoryStars INTEGER);
...
CREATE TABLE SceneFContent ("StoryID" INTEGER NOT NULL, "SceneID" INTEGER NOT NULL);
